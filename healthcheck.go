...
const (
	// HealthCheckStatusDegraged represents the value Degraged.
	HealthCheckStatusDegraged HealthCheckStatusValue = "Degraged"

	// HealthCheckStatusFail represents the value Fail.
	HealthCheckStatusFail HealthCheckStatusValue = "Fail"

	// HealthCheckStatusPass represents the value Pass.
	HealthCheckStatusPass HealthCheckStatusValue = "Pass"
)
...
const (
	...
	// HealthCheckTypeMessageBus represents the value MessageBus.
	HealthCheckTypeMessageBus HealthCheckTypeValue = "MessageBus"
...
type HealthCheck struct {
	// The list of affected endpoints the observed sub system is serving if applicable.
	AffectedEndpoints []string `json:"affectedEndpoints,omitempty" msgpack:"affectedEndpoints,omitempty" bson:"-" mapstructure:"affectedEndpoints,omitempty"`
	...
	// The name of the obeserved sub system if applicable.
...
A return code of different from 200 OK means the platform is not operational.
The HealthCheck contains the list of observed sub system.`
}
...
func (o *HealthCheck) ToSparse(fields ...string) elemental.SparseIdentifiable {
	...
	if len(fields) == 0 {
		...
		return &SparseHealthCheck{
			AffectedEndpoints: &o.AffectedEndpoints,
			Alerts:            &o.Alerts,
			Name:              &o.Name,
	...
	for _, f := range fields {
		switch f {
		case "affectedEndpoints":
			sp.AffectedEndpoints = &(o.AffectedEndpoints)
		case "alerts":
			sp.Alerts = &(o.Alerts)
		case "name":
			sp.Name = &(o.Name)
...
func (o *HealthCheck) Patch(sparse elemental.SparseIdentifiable) {
	...
	if so.AffectedEndpoints != nil {
		o.AffectedEndpoints = *so.AffectedEndpoints
	}
	if so.Alerts != nil {
		o.Alerts = *so.Alerts
	}
...
func (o *HealthCheck) Validate() error {
	...
	if err := elemental.ValidateStringInList("status", string(o.Status), []string{"Degraged", "Fail", "Pass"}, true); err != nil {
		errors = errors.Append(err)
	}

	if err := elemental.ValidateStringInList("type", string(o.Type), []string{"Cache", "Database", "General", "MessageBus", "Service", "TSDB"}, true); err != nil {
		errors = errors.Append(err)
	}
...
var HealthCheckAttributesMap = map[string]elemental.AttributeSpecification{
	"AffectedEndpoints": {
		...
		Autogenerated:  true,
		ConvertedName:  "AffectedEndpoints",
		Description:    `The list of affected endpoints the observed sub system is serving if applicable.`,
		Exposed:        true,
...
available.`,
	...
	"Name": {
		...
		Autogenerated:  true,
		ConvertedName:  "Name",
		Description:    `The name of the obeserved sub system if applicable.`,
		Exposed:        true,
		Name:           "name",
		ReadOnly:       true,
		Type:           "string",
	...
	"Status": {
		AllowedChoices: []string{"Degraged", "Fail", "Pass"},
		Autogenerated:  true,
	...
	"Type": {
		AllowedChoices: []string{"Cache", "Database", "General", "MessageBus", "Service", "TSDB"},
		Autogenerated:  true,
		ConvertedName:  "Type",
...
func (o *SparseHealthCheck) ToPlain() elemental.PlainIdentifiable {
	...
	out := NewHealthCheck()
	if o.AffectedEndpoints != nil {
		out.AffectedEndpoints = *o.AffectedEndpoints
	}
	if o.Alerts != nil {
		out.Alerts = *o.Alerts
	}
