...
func (o *Issue) Validate() error {
	...
	if err := elemental.ValidateStringInList("realm", string(o.Realm), []string{"AWSSecurityToken", "Certificate", "Google", "LDAP", "Vince", "GCPIdentityToken", "AzureIdentityToken", "OIDC", "SAML", "Twistlock", "PCCIdentityToken"}, false); err != nil {
		errors = errors.Append(err)
	}
...
for further information.`,
	...
	"Realm": elemental.AttributeSpecification{
		AllowedChoices: []string{"AWSSecurityToken", "Certificate", "Google", "LDAP", "Vince", "GCPIdentityToken", "AzureIdentityToken", "OIDC", "SAML", "Twistlock", "PCCIdentityToken"},
		ConvertedName:  "Realm",
