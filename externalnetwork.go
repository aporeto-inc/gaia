...
func (o *ExternalNetwork) GetZone() string {

	return o.Zone
}

// SetZone sets the property Zone of the receiver using the given value.
func (o *ExternalNetwork) SetZone(zone string) {
...
// GetZone returns the Zone of the receiver.
func (o *SparseExternalNetwork) GetZone() string {

	return *o.Zone
}

// SetZone sets the property Zone of the receiver using the address of the given value.
func (o *SparseExternalNetwork) SetZone(zone string) {
