...
type Enforcer struct {
	...
	// This fields indicates whether the enforcer will ignore host mode containers. This is `true` by default.
	DetectecHostModeContainer bool `json:"detectecHostModeContainer" msgpack:"detectecHostModeContainer" bson:"detectechostmodecontainer" mapstructure:"detectecHostModeContainer,omitempty"`
...
func (o *Enforcer) GetBSON() (interface{}, error) {
	...
	s.DetectecHostModeContainer = o.DetectecHostModeContainer
...
func (o *Enforcer) SetBSON(raw bson.Raw) error {
	...
	o.DetectecHostModeContainer = s.DetectecHostModeContainer
...
func (o *Enforcer) ToSparse(fields ...string) elemental.SparseIdentifiable {
	...
	if len(fields) == 0 {
		...
		return &SparseEnforcer{
			...
			DetectecHostModeContainer: &o.DetectecHostModeContainer,
	...
	for _, f := range fields {
		...
		case "detectecHostModeContainer":
			sp.DetectecHostModeContainer = &(o.DetectecHostModeContainer)
...
func (o *Enforcer) Patch(sparse elemental.SparseIdentifiable) {
	...
	if so.DetectecHostModeContainer != nil {
		o.DetectecHostModeContainer = *so.DetectecHostModeContainer
	}
...
func (o *Enforcer) ValueForAttribute(name string) interface{} {
	...
	case "description":
		return o.Description
	case "detectecHostModeContainer":
		return o.DetectecHostModeContainer
	case "enforcementStatus":
...
useful when federating multiple Microsegmentation Consoles.`,
	...
	"DetectecHostModeContainer": {
		AllowedChoices: []string{},
		Autogenerated:  true,
		BSONFieldName:  "detectechostmodecontainer",
		ConvertedName:  "DetectecHostModeContainer",
		Description:    `This fields indicates whether the enforcer will ignore host mode containers. This is ` + "`" + `true` + "`" + ` by default.`,
		Exposed:        true,
		Name:           "detectecHostModeContainer",
		Stored:         true,
		Transient:      true,
		Type:           "boolean",
	},
...
type SparseEnforcer struct {
	...
	// This fields indicates whether the enforcer will ignore host mode containers. This is `true` by default.
	DetectecHostModeContainer *bool `json:"detectecHostModeContainer,omitempty" msgpack:"detectecHostModeContainer,omitempty" bson:"detectechostmodecontainer,omitempty" mapstructure:"detectecHostModeContainer,omitempty"`
...
func (o *SparseEnforcer) GetBSON() (interface{}, error) {
	...
	if o.DetectecHostModeContainer != nil {
		s.DetectecHostModeContainer = o.DetectecHostModeContainer
	}
...
func (o *SparseEnforcer) SetBSON(raw bson.Raw) error {
	...
	if s.DetectecHostModeContainer != nil {
		o.DetectecHostModeContainer = s.DetectecHostModeContainer
	}
...
func (o *SparseEnforcer) ToPlain() elemental.PlainIdentifiable {
	...
	if o.DetectecHostModeContainer != nil {
		out.DetectecHostModeContainer = *o.DetectecHostModeContainer
	}
	if o.EnforcementStatus != nil {
...
type mongoAttributesEnforcer struct {
	...
	DetectecHostModeContainer bool                           `bson:"detectechostmodecontainer"`
...
type mongoAttributesSparseEnforcer struct {
	...
	DetectecHostModeContainer *bool                           `bson:"detectechostmodecontainer,omitempty"`
