...
func (o *FileAccessPolicy) GetZone() string {

	return o.Zone
}

// SetZone sets the property Zone of the receiver using the given value.
func (o *FileAccessPolicy) SetZone(zone string) {
...
// GetZone returns the Zone of the receiver.
func (o *SparseFileAccessPolicy) GetZone() string {

	return *o.Zone
}

// SetZone sets the property Zone of the receiver using the address of the given value.
func (o *SparseFileAccessPolicy) SetZone(zone string) {
