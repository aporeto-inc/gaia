...
// RoleVisibilityValue represents the possible values for attribute "visibility".
type RoleVisibilityValue string

const (
	// RoleVisibilityBoth represents the value Both.
	RoleVisibilityBoth RoleVisibilityValue = "Both"

	// RoleVisibilityOnPremise represents the value OnPremise.
	RoleVisibilityOnPremise RoleVisibilityValue = "OnPremise"

	// RoleVisibilityPrivate represents the value Private.
	RoleVisibilityPrivate RoleVisibilityValue = "Private"

	// RoleVisibilitySAAS represents the value SAAS.
	RoleVisibilitySAAS RoleVisibilityValue = "SAAS"
)
...
type Role struct {
	...
	// Set the visibility of the role.
	Visibility RoleVisibilityValue `json:"visibility" msgpack:"visibility" bson:"-" mapstructure:"visibility,omitempty"`
...
func (o *Role) Validate() error {
	...
	if err := elemental.ValidateStringInList("visibility", string(o.Visibility), []string{"Private", "SAAS", "OnPremise", "Both"}, true); err != nil {
...
var RoleAttributesMap = map[string]elemental.AttributeSpecification{
	...
	"Visibility": {
		AllowedChoices: []string{"Private", "SAAS", "OnPremise", "Both"},
		Autogenerated:  true,
		ConvertedName:  "Visibility",
		DefaultValue:   RoleVisibilityBoth,
		Description:    `Set the visibility of the role.`,
		Exposed:        true,
		Name:           "visibility",
		ReadOnly:       true,
		Type:           "enum",
...
type SparseRole struct {
	...
	// Set the visibility of the role.
	Visibility *RoleVisibilityValue `json:"visibility,omitempty" msgpack:"visibility,omitempty" bson:"-" mapstructure:"visibility,omitempty"`
