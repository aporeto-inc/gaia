...
type Account struct {
	// AWSCustomerID contains the aws customer id that can be used for billing.
	AWSCustomerID string `json:"AWSCustomerID" bson:"awscustomerid" mapstructure:"AWSCustomerID,omitempty"`
	...
	// Contains the invoice at the current state before written as due.
	CurrentInvoice *Invoice `json:"currentInvoice" bson:"-" mapstructure:"currentInvoice,omitempty"`
...
var AccountAttributesMap = map[string]elemental.AttributeSpecification{
	"AWSCustomerID": elemental.AttributeSpecification{
		AllowedChoices: []string{},
		Autogenerated:  true,
		ConvertedName:  "AWSCustomerID",
		Description:    `AWSCustomerID contains the aws customer id that can be used for billing.`,
		Exposed:        true,
		Format:         "free",
		Name:           "AWSCustomerID",
		ReadOnly:       true,
	...
	"CurrentInvoice": elemental.AttributeSpecification{
		AllowedChoices: []string{},
		Autogenerated:  true,
		ConvertedName:  "CurrentInvoice",
		Description:    `Contains the invoice at the current state before written as due.`,
		Exposed:        true,
		Name:           "currentInvoice",
		ReadOnly:       true,
		SubType:        "invoice",
