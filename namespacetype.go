...
// NamespaceTypeTypeValue represents the possible values for attribute "type".
type NamespaceTypeTypeValue string

const (
	// NamespaceTypeTypeCloudAccount represents the value CloudAccount.
	NamespaceTypeTypeCloudAccount NamespaceTypeTypeValue = "CloudAccount"

	// NamespaceTypeTypeDefault represents the value Default.
	NamespaceTypeTypeDefault NamespaceTypeTypeValue = "Default"

	// NamespaceTypeTypeHostGroup represents the value HostGroup.
	NamespaceTypeTypeHostGroup NamespaceTypeTypeValue = "HostGroup"

	// NamespaceTypeTypeKubernetes represents the value Kubernetes.
	NamespaceTypeTypeKubernetes NamespaceTypeTypeValue = "Kubernetes"

	// NamespaceTypeTypeKubernetesClusterGroup represents the value KubernetesClusterGroup.
	NamespaceTypeTypeKubernetesClusterGroup NamespaceTypeTypeValue = "KubernetesClusterGroup"

	// NamespaceTypeTypeTenant represents the value Tenant.
	NamespaceTypeTypeTenant NamespaceTypeTypeValue = "Tenant"
)
...
type NamespaceType struct {
	...
	Type NamespaceTypeTypeValue `json:"type" msgpack:"type" bson:"-" mapstructure:"type,omitempty"`
...
var NamespaceTypeAttributesMap = map[string]elemental.AttributeSpecification{
	"Type": {
		...
		Autogenerated:  true,
		ConvertedName:  "Type",
		DefaultValue:   NamespaceTypeTypeDefault,
...
type SparseNamespaceType struct {
	...
	// - `Kubernetes`: A child namespace of a Kubernetes cluster group that houses a
	// Kubernetes cluster (automatically created by the enforcer).
	Type *NamespaceTypeTypeValue `json:"type,omitempty" msgpack:"type,omitempty" bson:"-" mapstructure:"type,omitempty"`
