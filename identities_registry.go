...
var (
	...
	indexesMap = map[string][][]string{
		...
		"activity": [][]string{
			...
			[]string{":shard", "zone", "namespace", "id"},
		},
		"alarm": [][]string{
			[]string{"namespace"},
		...
		"authority": [][]string{
			[]string{"commonName"},
			[]string{"serialNumber"},
			[]string{":shard", "zone", "serialNumber"},
		},
		"automation": [][]string{
			[]string{"namespace"},
			[]string{":shard", "zone", "namespace", "id"},
		...
		"processingunit": [][]string{
			...
			[]string{":shard", "zone", "namespace", "enforcerID"},
		},
