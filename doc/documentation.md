...
| [K8SCredential](#k8scredential)                               | Create a credential for a kubernetes cluster.                                       |
...
Create a credential for a kubernetes cluster.
...
Retrieves the list of kubernetes credentials.
...
Creates a new kubernetes credential.

#### `DELETE /k8scredentials/:id`
...
#### `GET /k8scredentials/:id`

Retrieves the object with the given ID.

#### `PUT /k8scredentials/:id`
...
#### `secretDefinition (external:k8s_secret_definition)`
