...
##### `insertTS` [`autogenerated`,`read_only`]
...
Type: [`interfacedata`](#interfacedata)
...
Type: `enum(Endpoint | Subnet | VPC | Interface | RouteTable)`
...
Type: `enum(Instance | LoadBalancer | PeeringConnection | Service | Gateway | TransitGateway)`
...
```json
{
  "subnet": "subnet-074c152ae45ea0c73",
  "type": "Instance"
}
```
...
Type: `enum(Instance | LoadBalancer | Gateway | Service | TransitGateway)`
