...
| [GCPAccount](#gcpaccount)                                     | Allows to bind an GCP account to your Aporeto account to allow auto registration... |
...
```json
{
  "JSONCredentialFile": "{\u003ccredential file content\u003e}"
}
```
...
Retrieves the list of gcp account bindings.
