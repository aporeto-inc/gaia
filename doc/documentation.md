...
| Resource                | Description                                                                    |
| -                       | -                                                                              |
| [OAUTHInfo](#oauthinfo) | OAUTHInfo provides the information for an OAUTH server to retrieve the secrets |
| [OAUTHKey](#oauthkey)   | OAUTHInfo provides the information for an OAUTH server to retrieve the secrets |
...
##### `auhorization_endpoint` `string` [`autogenerated`,`read_only`]

Authorization_Endpoint is the authorization endpoint.

##### `claims_supported` `[]string` [`autogenerated`,`read_only`]

claims_supported is corresponding attribute of the OIDC spec.

##### `id_token_signing_alg_values_supported` `[]string` [`autogenerated`,`read_only`]
...
##### `type` `emum(X509 | SSH | Token)` [`autogenerated`,`read_only`]
...
| Resource                      | Description                                                                     |
| -                             | -                                                                               |
| [ServiceToken](#servicetoken) | This API issues a new service token using the namespace certificate that can be |
