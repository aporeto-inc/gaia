...
#### `subject (external:list_of_list_of_strings)`
...
#### `allowedScopes (external:list_of_list_of_strings)`
...
#### `ignoreExpression (external:list_of_list_of_strings)`
...
#### `object (external:list_of_list_of_strings)`
...
#### `match (external:list_of_list_of_strings)`
...
#### `tagClauses (external:list_of_list_of_strings)`
...
#### `isolationProfileSelector (external:list_of_list_of_strings)`
...
#### `exposedAPIs (external:list_of_list_of_strings)`
...
#### `selectors (external:list_of_list_of_strings)`
...
#### `rows (external:list_of_list_of_objects)`
