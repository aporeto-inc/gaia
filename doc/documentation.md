...
##### `destinations` [`autogenerated`,`read_only`]

Type: [`map[string]cloudnetworkquerydestination`](#cloudnetworkquerydestination)
...
##### `nativeID` [`autogenerated`]

Type: `string`

The native ID of the node.

##### `policies` [`autogenerated`]
...
##### `action` [`autogenerated`,`read_only`]
...
Creates a new cloud network query.
...
Creates a cloud toplogy based on ingested data and the required parameters.
...
Creates a new cloud attachment.

Parameters:

- `q` (`string`): Filtering query. Consequent `q` parameters will form an or.

##### `DELETE /cloudattachments/:id`

Deletes the cloud attachment with the given ID.

Parameters:

- `q` (`string`): Filtering query. Consequent `q` parameters will form an or.

##### `GET /cloudattachments/:id`

Retrieves the cloud attachment with the given ID.

##### `PUT /cloudattachments/:id`

Updates the cloud attachment with the given ID.
...
Type: `enum(TransitGatewayVPCAttachment | TransitGatewayAttachment)`
...
Type: `enum(Instance | LoadBalancer | Gateway | Service | TransitGatewayVPCAttachment)`
...
Creates a new cloud network rule set policy policy.
...
Updates the cloud node with the given ID.
...
##### `securityTags` [`autogenerated`]

Type: `[]string`

List of security tags associated with the node.

##### `subType` [`autogenerated`]
...
Creates a new VPC object representing a cloud VPC structure.
