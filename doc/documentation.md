...
##### `GET /containerimages/:id/cves`

Returns the list of CVEs of a container image.
...
```json
{
  ...
  "severity": "Critical",
  "status": "Open",
  "statusMessage": "fixed in 1.7.6-2+deb9u3",
...
Deletes the vulnerability with the given ID.
...
Retrieves a vulnerability with a given ID.
...
Updates the vulnerability with the given ID.
...
##### `severity` `emum(Critical | High | Medium | Low)`

Severity of the vulnerability.

##### `status` `emum(Open | Fixed)`
...
{
  "cvss": 4.7,
  "link": "https://complianceIssue.com/CVE-1234",
  "name": "the name",
  "protected": false,
  "severity": "Critical"
}
