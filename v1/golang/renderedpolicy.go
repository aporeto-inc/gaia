...
type RenderedPolicy struct {
	...
	// identityTags contains the list of tags that matched the policies and their
	// hashes.
	IdentityTags map[string]string `json:"identityTags" bson:"-" mapstructure:"identityTags,omitempty"`
...
implementing.`,
	...
	"IdentityTags": elemental.AttributeSpecification{
		AllowedChoices: []string{},
		Autogenerated:  true,
		ConvertedName:  "IdentityTags",
		Description: `identityTags contains the list of tags that matched the policies and their
hashes.`,
		Exposed:  true,
		Name:     "identityTags",
		ReadOnly: true,
		SubType:  "identity_tags",
		Type:     "external",
	},
