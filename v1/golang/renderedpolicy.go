...
type RenderedPolicy struct {
	...
	// CertificateRequest is the certificate requested initiated by the client when they are rendering the policy. It set, the system will create a new certificate for this PU.
...
var RenderedPolicyAttributesMap = map[string]elemental.AttributeSpecification{
	...
	"CertificateRequest": elemental.AttributeSpecification{
		...
		Description:    `CertificateRequest is the certificate requested initiated by the client when they are rendering the policy. It set, the system will create a new certificate for this PU.`,
		Exposed:        true,
		Format:         "free",
