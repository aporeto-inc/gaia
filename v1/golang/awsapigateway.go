...
func (o AWSApiGatewaysList) ContentIdentity() elemental.Identity {

	return AWSApiGatewayIdentity
}

// Copy returns a pointer to a copy the AWSApiGatewaysList.
func (o AWSApiGatewaysList) Copy() elemental.ContentIdentifiable {
...
func (o AWSApiGatewaysList) Append(objects ...elemental.Identifiable) elemental.ContentIdentifiable {
