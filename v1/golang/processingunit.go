...
type ProcessingUnit struct {
	// CAPool is the list of CAs that the enforcer should trust for the external API or TLS services.
	CAPool string `json:"CAPool" bson:"-" mapstructure:"CAPool,omitempty"`

	// Certificate returns the certificate associated with this processing unit. It can be used by the PU itself or by proxies on behalf of the PU.
	Certificate string `json:"certificate" bson:"certificate" mapstructure:"certificate,omitempty"`

	// CertificateExpiration is the expiration date of the current certificate of the PU.
	CertificateExpiration time.Time `json:"certificateExpiration" bson:"certificateexpiration" mapstructure:"certificateExpiration,omitempty"`

	// CertificateRequest is a CSR asking for a certificate for this PU.
...
var ProcessingUnitAttributesMap = map[string]elemental.AttributeSpecification{
	"CAPool": elemental.AttributeSpecification{
		AllowedChoices: []string{},
		ConvertedName:  "CAPool",
		Description:    `CAPool is the list of CAs that the enforcer should trust for the external API or TLS services.`,
		Exposed:        true,
		Format:         "free",
		Name:           "CAPool",
		Type:           "string",
	...
	"CertificateExpiration": elemental.AttributeSpecification{
		AllowedChoices: []string{},
		ConvertedName:  "CertificateExpiration",
