...
func (o AWSRegistersList) ContentIdentity() elemental.Identity {

	return AWSRegisterIdentity
}

// Copy returns a pointer to a copy the AWSRegistersList.
func (o AWSRegistersList) Copy() elemental.ContentIdentifiable {
...
func (o AWSRegistersList) Append(objects ...elemental.Identifiable) elemental.ContentIdentifiable {
