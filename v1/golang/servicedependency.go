...
func (o ServiceDependenciesList) ContentIdentity() elemental.Identity {

	return ServiceDependencyIdentity
}

// Copy returns a pointer to a copy the ServiceDependenciesList.
func (o ServiceDependenciesList) Copy() elemental.ContentIdentifiable {
...
func (o ServiceDependenciesList) Append(objects ...elemental.Identifiable) elemental.ContentIdentifiable {
