...
type Export struct {
	...
	// List of all exported service dependencies.
	ServiceDependencies []map[string]interface{} `json:"serviceDependencies,omitempty" bson:"-" mapstructure:"serviceDependencies,omitempty,omitempty"`
...
recognize imported object in a later import.`,
	...
	"ServiceDependencies": elemental.AttributeSpecification{
		AllowedChoices: []string{},
		Autogenerated:  true,
		ConvertedName:  "ServiceDependencies",
		Description:    `List of all exported service dependencies.`,
		Exposed:        true,
