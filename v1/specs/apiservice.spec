{
    "attributes": [
        ...
        },
        {
            ...
            "default_value": null,
            "deprecated": null,
            "description": "JWTCertificate is a certificate that can be used to validate user JWT in HTTP requests. This is an optional field needed if user JWT validation is required for this service. ",
            "exposed": true,
            "filterable": true,
            "foreign_key": null,
            "format": "free",
