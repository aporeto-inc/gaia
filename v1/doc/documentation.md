...
| [PolicyRenderer](#policyrenderer)                             | Returns the list of hook policies that matches the given set of tags.               |
...
Returns the list of hook policies that matches the given set of tags.

### Example

```json
{
  "policyType": "APIAuthorization",
  "targetTags": [
    "a=a",
    "b=b"
  ]
...
| Method | URL                | Description                                              |
| -:     | -                  | -                                                        |
| `POST` | `/policyrenderers` | Render a policy of a given type for a given set of tags. |

### Attributes

#### `policies (external:policy_rules_list)`
