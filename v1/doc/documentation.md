...
| [ServicePolicy](#servicepolicy)                               | A ServicePolicy allows to declare what Services one or a group of processing        |
...
| Method   | URL                    | Description                                        |
| -:       | -                      | -                                                  |
| `DELETE` | `/servicepolicies/:id` | Deletes the `servicepolicy` with the given `:id`.  |
| `GET`    | `/servicepolicies/:id` | Retrieve the `servicepolicy` with the given `:id`. |
| `PUT`    | `/servicepolicies/:id` | Updates the `servicepolicy` with the given `:id`.  |
