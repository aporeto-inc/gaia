...
| [Service](#service)                                           | Service descibes a L4/L7 service and the corresponding implementation. It           |
...
Service descibes a L4/L7 service and the corresponding implementation. It
...
for external services. For HTTP services, FQND must match the host part
...
an optional field and it can be automatically populated at runtime by the
enforcers if DNS resolution is available.
