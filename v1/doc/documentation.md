...
| [Customer](#customer)                                         | This api allows to view and manage basic information about customer profile for     |
...
| Characteristics | Value                                                                        |
| -               | -:                                                                           |
| Allowed Value   | `SubscribePending, SubscribeSuccess, UnsubscribePending, UnsubscribeSuccess` |
| Default         | `SubscribePending`                                                           |
| Read only       | `true`                                                                       |
