...
const (
	...
	// TrustedCATypeToken represents the value Token.
	TrustedCATypeToken TrustedCATypeValue = "Token"
...
func (o *TrustedCA) Validate() error {
	...
	if err := elemental.ValidateStringInList("type", string(o.Type), []string{"X509", "SSH", "Token"}, true); err != nil {
...
namespace.`,
	...
	"Type": elemental.AttributeSpecification{
		AllowedChoices: []string{"X509", "SSH", "Token"},
		Autogenerated:  true,
		ConvertedName:  "Type",
