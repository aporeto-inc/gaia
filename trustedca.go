...
type TrustedCA struct {
	...
	// The ID of the platform that this certificate or CA was issued from.
	PlatformID string `json:"platformID" msgpack:"platformID" bson:"-" mapstructure:"platformID,omitempty"`
...
func (o *TrustedCA) Patch(sparse elemental.SparseIdentifiable) {
	...
	if so.PlatformID != nil {
		o.PlatformID = *so.PlatformID
	}
...
namespace.`,
	...
	"PlatformID": {
		AllowedChoices: []string{},
		Autogenerated:  true,
		ConvertedName:  "PlatformID",
		Description:    `The ID of the platform that this certificate or CA was issued from.`,
		Exposed:        true,
		Name:           "platformID",
		ReadOnly:       true,
		Type:           "string",
...
type SparseTrustedCA struct {
	...
	// The ID of the platform that this certificate or CA was issued from.
	PlatformID *string `json:"platformID,omitempty" msgpack:"platformID,omitempty" bson:"-" mapstructure:"platformID,omitempty"`
