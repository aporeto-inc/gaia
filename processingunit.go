...
func (o *ProcessingUnit) GetZone() string {

	return o.Zone
}

// SetZone sets the property Zone of the receiver using the given value.
func (o *ProcessingUnit) SetZone(zone string) {
...
// GetZone returns the Zone of the receiver.
func (o *SparseProcessingUnit) GetZone() string {

	return *o.Zone
}

// SetZone sets the property Zone of the receiver using the address of the given value.
func (o *SparseProcessingUnit) SetZone(zone string) {
