...
type EnforcerProfileMappingPolicy struct {
	...
	// geographical zone of the data. This is used for georedundancy.
	Zone string `json:"-" bson:"zone" mapstructure:"-,omitempty"`
...
func (o *EnforcerProfileMappingPolicy) GetZone() string {

	return o.Zone
}

// SetZone sets the property Zone of the receiver using the given value.
func (o *EnforcerProfileMappingPolicy) SetZone(zone string) {
...
with the '@' prefix, and should only be used by external systems.`,
	...
	"Zone": elemental.AttributeSpecification{
		...
		Autogenerated:  true,
		ConvertedName:  "Zone",
		Description:    `geographical zone of the data. This is used for georedundancy.`,
		Getter:         true,
		Name:           "zone",
		ReadOnly:       true,
		Setter:         true,
...
type SparseEnforcerProfileMappingPolicy struct {
	...
	// geographical zone of the data. This is used for georedundancy.
	Zone *string `json:"-,omitempty" bson:"zone" mapstructure:"-,omitempty"`
...
// GetZone returns the Zone of the receiver.
func (o *SparseEnforcerProfileMappingPolicy) GetZone() string {

	return *o.Zone
}

// SetZone sets the property Zone of the receiver using the address of the given value.
func (o *SparseEnforcerProfileMappingPolicy) SetZone(zone string) {
