...
type GraphEdge struct {
	...
	FlowID string `json:"ID" msgpack:"ID" bson:"id" mapstructure:"ID,omitempty"`
...
type SparseGraphEdge struct {
	...
	// Identifier of the edge.
	FlowID *string `json:"ID,omitempty" msgpack:"ID,omitempty" bson:"id,omitempty" mapstructure:"ID,omitempty"`
