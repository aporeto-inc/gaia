...
func (o *EnforcerProfile) GetZone() string {

	return o.Zone
}

// SetZone sets the property Zone of the receiver using the given value.
func (o *EnforcerProfile) SetZone(zone string) {
...
// GetZone returns the Zone of the receiver.
func (o *SparseEnforcerProfile) GetZone() string {

	return *o.Zone
}

// SetZone sets the property Zone of the receiver using the address of the given value.
func (o *SparseEnforcerProfile) SetZone(zone string) {
