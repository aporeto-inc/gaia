...
type CloudGraph struct {
	...
	// associated verdicts.
	Destinations map[string]*CloudNetworkQueryDestination `json:"destinations" msgpack:"destinations" bson:"-" mapstructure:"destinations,omitempty"`
...
func NewCloudGraph() *CloudGraph {
	...
	return &CloudGraph{
		ModelVersion:  1,
		Destinations:  map[string]*CloudNetworkQueryDestination{},
...
func (o *CloudGraph) ToSparse(fields ...string) elemental.SparseIdentifiable {
	...
	for _, f := range fields {
		switch f {
		case "destinations":
			sp.Destinations = &(o.Destinations)
		case "internalEdges":
...
func (o *CloudGraph) Patch(sparse elemental.SparseIdentifiable) {
	...
	if so.Destinations != nil {
		o.Destinations = *so.Destinations
	}
...
func (o *CloudGraph) Validate() error {
	...
	for _, sub := range o.Destinations {
		if sub == nil {
			continue
		}
...
type SparseCloudGraph struct {
	// The set of destinations that have been discovered based on the query and their
	// associated verdicts.
	Destinations *map[string]*CloudNetworkQueryDestination `json:"destinations,omitempty" msgpack:"destinations,omitempty" bson:"-" mapstructure:"destinations,omitempty"`
...
func (o *SparseCloudGraph) ToPlain() elemental.PlainIdentifiable {
	...
	if o.Destinations != nil {
		out.Destinations = *o.Destinations
	}
