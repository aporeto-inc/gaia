...
type Automation struct {
	...
	// Contains the most recent Aporeto token used by the Automation's HTTP client.
...
var AutomationAttributesMap = map[string]elemental.AttributeSpecification{
	...
	"AporetoToken": elemental.AttributeSpecification{
		...
		Description:    `Contains the most recent Aporeto token used by the Automation's HTTP client.`,
		Encrypted:      true,
		Name:           "aporetoToken",
		Stored:         true,
		Type:           "string",
