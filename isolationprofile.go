...
func (o *IsolationProfile) GetZone() string {

	return o.Zone
}

// SetZone sets the property Zone of the receiver using the given value.
func (o *IsolationProfile) SetZone(zone string) {
...
// GetZone returns the Zone of the receiver.
func (o *SparseIsolationProfile) GetZone() string {

	return *o.Zone
}

// SetZone sets the property Zone of the receiver using the address of the given value.
func (o *SparseIsolationProfile) SetZone(zone string) {
