...
func (o *TokenScopePolicy) GetZone() string {

	return o.Zone
}

// SetZone sets the property Zone of the receiver using the given value.
func (o *TokenScopePolicy) SetZone(zone string) {
...
// GetZone returns the Zone of the receiver.
func (o *SparseTokenScopePolicy) GetZone() string {

	return *o.Zone
}

// SetZone sets the property Zone of the receiver using the address of the given value.
func (o *SparseTokenScopePolicy) SetZone(zone string) {
