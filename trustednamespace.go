...
type TrustedNamespace struct {
	...
	// The serialNumber of the certificate authority.
	...
	// The platform of the trusted namespace. Empty means local.
...
var TrustedNamespaceAttributesMap = map[string]elemental.AttributeSpecification{
	...
	"RemoteNamespace": {
		...
		Description:    `The serialNumber of the certificate authority.`,
		Exposed:        true,
	...
	"RemotePlatform": {
		...
		Description:    `The platform of the trusted namespace. Empty means local.`,
		Exposed:        true,
		Name:           "remotePlatform",
		ReadOnly:       true,
		Stored:         true,
	...
	"SerialNumber": {
		...
		Description:    `The namespace that is trusted.`,
		Exposed:        true,
		Name:           "serialNumber",
		ReadOnly:       true,
		Stored:         true,
