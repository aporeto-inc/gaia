...
type Service struct {
	...
	// AccountEmail used for the service certtificate
	AccountEmail string `json:"accountEmail" bson:"accountemail"`
...
var ServiceAttributesMap = map[string]elemental.AttributeSpecification{
	...
	"AccountEmail": elemental.AttributeSpecification{
		AllowedChoices: []string{},
	...
	"Namespace": elemental.AttributeSpecification{
		AllowedChoices: []string{},
		Description:    `Namespace represents the namespace`,
		Exposed:        true,
		Filterable:     true,
		Format:         "free",
		Name:           "namespace",
