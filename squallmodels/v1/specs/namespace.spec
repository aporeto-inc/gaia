{
    "attributes": [
        ...
        },
        {
            ...
            "default_value": null,
            "deprecated": null,
            "description": "If set to true, the namespace and its entire hierarchy will be in obversation mode. All instances of enforcerd that have not explicity enabled or disabled it will use this setting to tell if it should be in observation mode.",
            "exposed": true,
            "filterable": true,
            "foreign_key": null,
            "format": "free",
