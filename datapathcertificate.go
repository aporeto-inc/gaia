...
type DataPathCertificate struct {
	...
	// Certificate there will be various requirement for the CSR to be accepted. If it
	// is a request of type Service the CSR can be empty. In this case we only respond
	// with a token.
	CSR string `json:"CSR" msgpack:"CSR" bson:"-" mapstructure:"CSR,omitempty"`

	// Audience is the requested audience for the token. Applies only to requests of
	// type Service.
	...
	// Contains the CA that signed the delivered certificates.
	Signer string `json:"signer" msgpack:"signer" bson:"-" mapstructure:"signer,omitempty"`

	// Contains a JWT token for either the enforcer or the service.
...
with a token.`,
	...
	"Audience": elemental.AttributeSpecification{
		...
		Description: `Audience is the requested audience for the token. Applies only to requests of
type Service.`,
		Exposed: true,
		Name:    "audience",
		Type:    "string",
	...
	"Signer": elemental.AttributeSpecification{
		...
		Description:    `Contains the CA that signed the delivered certificates.`,
		Exposed:        true,
		Name:           "signer",
		ReadOnly:       true,
		Type:           "string",
	...
	"Token": elemental.AttributeSpecification{
		...
		Autogenerated:  true,
		ConvertedName:  "Token",
		Description:    `Contains a JWT token for either the enforcer or the service.`,
		Exposed:        true,
		Name:           "token",
		ReadOnly:       true,
		Type:           "string",
