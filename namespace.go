...
type Namespace struct {
	...
	JWTCertificate string `json:"JWTCertificate" msgpack:"JWTCertificate" bson:"jwtcertificate" mapstructure:"JWTCertificate,omitempty"`
...
func (o *Namespace) ToSparse(fields ...string) elemental.SparseIdentifiable {
	...
	if len(fields) == 0 {
		...
		return &SparseNamespace{
			ID:                         &o.ID,
			JWTCertificate:             &o.JWTCertificate,
	...
	for _, f := range fields {
		...
		case "ID":
			sp.ID = &(o.ID)
		case "JWTCertificate":
			sp.JWTCertificate = &(o.JWTCertificate)
...
func (o *Namespace) Patch(sparse elemental.SparseIdentifiable) {
	...
	if so.JWTCertificate != nil {
		o.JWTCertificate = *so.JWTCertificate
	}
...
var NamespaceAttributesMap = map[string]elemental.AttributeSpecification{
	...
	"JWTCertificate": elemental.AttributeSpecification{
		...
		Description: `JWTCertificate holds the certificate for signing JWTs for applications placed
under this namespace.`,
		Exposed:  true,
		Name:     "JWTCertificate",
		ReadOnly: true,
...
type SparseNamespace struct {
	...
	// JWTCertificate holds the certificate for signing JWTs for applications placed
	// under this namespace.
	JWTCertificate *string `json:"JWTCertificate,omitempty" msgpack:"JWTCertificate,omitempty" bson:"jwtcertificate,omitempty" mapstructure:"JWTCertificate,omitempty"`
...
func (o *SparseNamespace) ToPlain() elemental.PlainIdentifiable {
	...
	if o.JWTCertificate != nil {
		out.JWTCertificate = *o.JWTCertificate
	}
