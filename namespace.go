...
type Namespace struct {
	...
	JWTCertificates []string `json:"JWTCertificates" msgpack:"JWTCertificates" bson:"jwtcertificates" mapstructure:"JWTCertificates,omitempty"`
...
type SparseNamespace struct {
	...
	// JWTCertificate holds the certificate for signing JWTs for applications placed
	// under this namespace.
	JWTCertificates *[]string `json:"JWTCertificates,omitempty" msgpack:"JWTCertificates,omitempty" bson:"jwtcertificates,omitempty" mapstructure:"JWTCertificates,omitempty"`
