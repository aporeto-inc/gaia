...
func (o *APIAuthorizationPolicy) GetZone() string {

	return o.Zone
}

// SetZone sets the property Zone of the receiver using the given value.
func (o *APIAuthorizationPolicy) SetZone(zone string) {
...
// GetZone returns the Zone of the receiver.
func (o *SparseAPIAuthorizationPolicy) GetZone() string {

	return *o.Zone
}

// SetZone sets the property Zone of the receiver using the address of the given value.
func (o *SparseAPIAuthorizationPolicy) SetZone(zone string) {
